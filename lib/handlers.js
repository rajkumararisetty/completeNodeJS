...
handlers.checksCreate = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('checksCreate', templateData, (error, string) => {
      if (!error && string) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(string, templateData, (error, string) => {
          if (!error && string) {
...
handlers.checksEdit = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('checksEdit', templateData, (error, string) => {
      if (!error && string) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(string, templateData, (error, string) => {
          if (!error && string) {
...
handlers.checksList = (data, callback) => {
  ...
  if (data.method === 'get') {
    ...
    // Read in a template as a string
    helpers.getTemplate('checksList', templateData, (error, string) => {
      if (!error && string) {
        // Add the universal header and footer
        helpers.addUniversalTemplates(string, templateData, (error, string) => {
          if (!error && string) {
